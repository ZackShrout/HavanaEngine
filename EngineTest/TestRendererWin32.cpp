...
create_camera_surface(camera_surface &surface, platform::window_init_info info)
{
	...
	surface.entity = create_one_game_entity({ 13.76f, 3.f, -1.1f }, { -0.137f, -1.7f, 0.f }, "camera_script");
